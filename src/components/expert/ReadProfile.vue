  ...
  <div class="editProfileContent" v-cloak>
        ...
        <section class="ep_part" id="projectHistoryABS">
            <header class="ep_part_title" v-bind:class="[isArrayEmpty(userInfo.ABSProjects) ? '' : 'ep_part_item_border']">
                ...
                <router-link v-if="userInfo.ABSProjects && userInfo.ABSProjects.length > 3" v-bind:to="routeUrls.ReadAbsHistoryList" class="fr ep_color_grey ep_font24">
                    更多
                </router-link>  
            </header>
            <div v-if="!isArrayEmpty(userInfo.ABSProjects)" v-cloak>
                <div class="ep_padding30 ep_part_item_border" v-for="(item, key) in _.take(userInfo.ABSProjects,3)" v-bind:key="key">
                    <div class="ep_overhide">
        ...
        <section class="ep_part" id="projectHistoryOther">
            <header class="ep_part_title" v-bind:class="[isArrayEmpty(userInfo.OtherProjects)?'':'ep_part_item_border']">
                ...
                <router-link v-if="userInfo.OtherProjects && userInfo.OtherProjects.length > 3" v-bind:to="routeUrls.ReadOtherProjectList" class="fr ep_color_grey ep_font24">
                    更多
                </router-link>  
            </header>
            <div v-if="!isArrayEmpty(userInfo.OtherProjects)" v-cloak>
                <div class="ep_padding30 ep_part_item_border" v-for="(item, key) in _.take(userInfo.OtherProjects, 3)" v-bind:key="key">
                    <div class="ep_overhide">
        ...
        <section class="ep_part" id="activity">
            <header class="ep_part_title" v-bind:class="[isArrayEmpty(userInfo.RecentActivities)?'':'ep_part_item_border']">
                ...
                <router-link v-if="userInfo.RecentActivities && userInfo.RecentActivities.length > 3" v-bind:to="routeUrls.ReadActivityList" class="fr ep_color_grey ep_font24">
                    更多
                </router-link>
            </header>
        ...
        <section class="ep_part" id="article">
            <header class="ep_part_title" v-bind:class="[isArrayEmpty(userInfo.Publishs)?'':'ep_part_item_border']">
                ...
                <router-link v-if="userInfo.Publishs && userInfo.Publishs.length > 3" v-bind:to="routeUrls.ReadArticleList" class="fr ep_color_grey ep_font24">
                    更多
                </router-link>  
            </header>
