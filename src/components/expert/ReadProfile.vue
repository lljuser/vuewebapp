  ...
  <div class="editProfileContent" v-cloak>
        ...
        <section class="ep_part" id="activity">
            <header class="ep_part_title" v-bind:class="[isArrayEmpty(userInfo.RecentActivities)?'':'ep_part_item_border']">
                ...
                <router-link v-if="userInfo.RecentActivities && userInfo.RecentActivities.length > 3" to="/ReadActivityList" class="fr ep_color_grey ep_font24">
                    更多
                </router-link>
            </header>
...
<script>
    ...
    export default {
        ...
        methods: {
            initData: function () {
                var self = this;
                var params = { UserId: getParams("UserId") };
