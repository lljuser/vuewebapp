        ...
        <div class="ep_content_div">
            ...
            <div class="ep_part_item_border ep_font32">
                ...
                <div v-if="!util.isArrayEmpty(projectHistory.OrganizationRoles)">
                    <div class="ep_multipleItem" v-for="(item,index) in projectHistory.OrganizationRoles" v-bind:class="[index===projectHistory.OrganizationRoles.length-1?'ep_marginBottom30':'ep_marginBottom20']">
...
export default {
    ...
    methods: {
        initData: function () {
            ...
            this.organizationRoles = [{"Id":19,"Role":"财务顾问"},{"Id":11,"Role":"差额支付承诺人"},{"Id":1,"Role":"承销商"},{"Id":12,"Role":"担保人"},{"Id":6,"Role":"发起机构"},{"Id":4,"Role":"发行人"},{"Id":8,"Role":"会计师事务所"},{"Id":2,"Role":"计划管理人"},{"Id":14,"Role":"监管银行"},{"Id":9,"Role":"律师事务所"},{"Id":26,"Role":"评估机构"},{"Id":10,"Role":"评级机构"},{"Id":5,"Role":"受托机构"},{"Id":20,"Role":"税务顾问"},{"Id":25,"Role":"投资者"},{"Id":13,"Role":"托管机构"},{"Id":23,"Role":"委托机构"},{"Id":17,"Role":"项目安排人"},{"Id":3,"Role":"原始权益人"},{"Id":7,"Role":"资产服务机构"},{"Id":15,"Role":"资金保管机构"},{"Id":24,"Role":"其它"}];
            this.personalResponsibilities = [{"Id":1,"Name":"部门负责人"},{"Id":2,"Name":"项目负责人"},{"Id":3,"Name":"项目参与人"},{"Id":4,"Name":"机构负责人"}];
        },
            ...
            if (this.projectHistory.Id === undefined) {
                appFrame.ajax("/expert/ExpertInfo/AddAbsProject", {
                    ...
                    success: function (res) {
                        if (res.status === "ok") {
                            window.location.href = '/expert/expertuser/editProfile#projectHistoryABS';
                        };
