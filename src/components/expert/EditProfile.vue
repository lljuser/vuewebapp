            ...
            <header class="ep_part_title">
                <div class='appH5_title fl' style='overflow:hidden;'>
                    ...
                    <span class="fl ep_marginLeft15 ep_font28 ep_overhide ep_line_height22" v-if="!isArrayEmpty(userInfo.ABSProjects)">
                        <span class="appH5_font_smaller">(共</span>
                        <span class="appH5_font_larger">{{projectHistoriesSummary.totalCount>9999?'9999+':projectHistoriesSummary.totalCount}}</span>
                        <span class="appH5_font_smaller">单，</span>
                        <span class="appH5_color_red appH5_font_larger">{{projectHistoriesSummary.totalOffering.toFixed(2)>9999?'9999+':projectHistoriesSummary.totalOffering.toFixed(2)}}</span>
                        <span class="appH5_font_smaller appH5_color_red">亿</span>
                        <span class="appH5_font_smaller">)</span>
                    </span>
                </div>
